...
const FAQ_ITEMS = [
  {
    ...
    a: 'З вами працюватиме вузькопрофільний фахівець. Ми не передаємо справи юристам-«універсалам». Щойно ви опишете свою ситуацію, ми уважно її вивчимо та підберемо з нашої команди саме того юриста, який має найбільший досвід у таких питаннях.'
  },
  {
    q: 'Чи можете ви представляти мене в суді?',
    a: 'Звісно. Більше того, вам взагалі не доведеться витрачати час на походи на засідання. Наш юрист захищатиме ваші інтереси дистанційно через офіційну систему «Електронний суд». Якщо ж ситуація вимагатиме особистої присутності в залі, ми просто залучимо до справи нашого колегу з вашого міста.'
  },
  {
