...
const SUBCATEGORIES = {
  military: {
    ...
    items: [
      { label: '🏥 Оскарження рішень ВЛК/МСЕК', id: 'ВЛК_МСЕК' },
      { label: '🪖 Мобілізація та відстрочка', id: 'Мобілізація' },
      { label: '📝 Звільнення зі служби', id: 'Звільнення' },
      { label: '🔄 Переведення та рапорти', id: 'Переведення' },
      { label: '💸 Виплати та забезпечення', id: 'Виплати' },
      { label: '👨‍👩‍👧 Сімейні справи', id: 'Сімейні_військ' },
  ...
  housing: {
    ...
    items: [
      ...
      { label: '💰 Компенсація за житло', id: 'Компенсація_житло' }
    ]
  },
  admin_offenses: {
    name: 'Адміністративні правопорушення',
    items: [
      { label: '🚦 Справи у сфері дорожнього руху', id: 'Дорожній_рух' },
      { label: '⚖️ Оскарження постанов', id: 'Оскарження_постанов' },
      { label: '🏛 Спори з органами влади', id: 'Спори_з_владою' },
      { label: '🛡 Військові адмін. правопорушення', id: 'Військові_адмін' }
    ]
  }
};
...
const getMainMenu = () => {
  return Markup.inlineKeyboard([
    [Markup.button.callback('🛡 Захист прав військовослужбовців', 'category_military')],
