...
const faqData = [
  {
    question: 'Чому ви називаєте себе юристами, а не адвокатами?',
    answer: 'Ми — команда колишніх юристів військових частин та органів управління ЗСУ. У більшості випадків вам не потрібен дорогий адвокат для представництва. Набагато ефективніше діяти від вашого імені. Ми повністю готуємо всі документи від заяви до позову та покроково пояснюємо, куди їх відправити. Ви захищаєте себе самі, але з нашою потужною підтримкою та експертизою.',
  },
  {
    question: 'Хто саме буде займатися моєю справою?',
    answer: 'З вами працюватиме фахівець, який раніше був на боці захисту військових частин. Ми знаємо всі бюрократичні лазівки Міноборони зсередини, і тепер використовуємо ці знання, щоб допомогти вам перемогти систему.',
  },
  {
    question: 'А що, якщо мою проблему неможливо вирішити?',
    answer: 'Ми беремося лише за ті справи, де реально бачимо законні шляхи вирішення. Якщо об\'єктивно шансів на успіх мало, ми прямо і чесно попередимо вас про це до початку роботи.',
  },
  {
    question: 'Як швидко я отримаю документи?',
    answer: 'Терміни залежать від складності:\n\n• Покроковий план дій — 1-2 дні.\n• Підготовка рапортів чи скарг — 2-3 дні.\n• Підготовка судового позову — від 3 днів.\nВам не треба нікуди їхати, всі готові документи та інструкції ви отримаєте прямо в Telegram.',
  },
];
          ...
          {[
            {
              ...
              check: 'text-blue-500',
              title: 'Інсайдери системи',
              items: ['Колишні юристи військових частин', 'Знаємо всі лазівки та слабкі місця', 'Наші документи працюють безвідмовно'],
            },
            {
              Icon: ShieldCheck,
              gradient: 'from-emerald-500 to-teal-600',
              check: 'text-emerald-500',
              title: 'Самостійний захист',
              items: ['Без переплат за адвокатів', 'Готуємо все: від заяви до позову', 'Ви подаєте від свого імені'],
            },
            {
              Icon: Zap,
