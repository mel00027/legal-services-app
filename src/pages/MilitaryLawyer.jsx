...
export const MilitaryLawyer = () => {
  const { data: cms } = useSanityQuery(SERVICE_PAGE_QUERY, null, { slug: 'military-lawyer' });
      ...
      <section className="relative overflow-hidden bg-transparent py-16 md:py-28 lg:py-36">
        ...
        >
          ...
          >
            ...
            <span className="text-gradient-blue"> {titleGradient}</span><br/>{titleEnd}
          </motion.h1>
      ...
      <section className="px-4 md:px-5 py-12 md:pb-32 bg-transparent text-center">
        ...
        >
          <motion.div variants={cardRise} style={{ willChange: 'transform, opacity' }}
            className="w-14 h-14 md:w-20 md:h-20 bg-gradient-to-br from-[#2563EB] to-[#7C3AED] rounded-2xl md:rounded-3xl flex items-center justify-center mx-auto mb-6 md:mb-8 shadow-[0_8px_32px_rgba(37,99,235,0.4)]"
          >
